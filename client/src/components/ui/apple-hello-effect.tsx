    ...
    >
      ...
      <motion.path
        ...
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(0.7),
          opacity: { duration: 0.45, delay: calc(0.7) },
        }}
      />
      {/* o */}
      <motion.path
        d="M189.6 142.465C189.6 115.17 203.992 93.8296 222.851 93.8296C237.739 93.8296 245.928 104.996 245.928 119.884C245.928 146.915 231.097 168.915 212.097 168.915C197.189 168.915 189.6 157.745 189.6 142.465Z"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeInOut",
          delay: calc(1.5),
          opacity: { duration: 0.6, delay: calc(1.5) },
        }}
      />
      {/* l */}
      <motion.path
        d="M270 7.43883C270 7.43883 270 96.0036 270 190.356"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
      ...
      {/* a */}
      <motion.path
        d="M310 112.995C305.007 101.8 294.666 94.2423 278.207 94.2423C250.912 94.2423 230.398 121.538 229.052 150.818C227.878 177.617 240.244 192.681 257.857 192.505C282.858 192.255 301.234 167.699 309.437 115.742C310.449 109.332 311.498 102.638 312.51 96.2274C311.486 102.73 310.461 109.232 309.436 115.735C304.955 144.175 302.887 155.395 303.109 162.729C303.628 179.85 309.785 191.513 326.064 191.513C348.563 191.513 366.966 164.721 376.266 138.289"
        style={{ strokeLinecap: "round" }}
        initial={initialProps}
        animate={animateProps}
        transition={{
          ...
          ease: "easeOut",
          delay: calc(3.1),
          opacity: { duration: 0.65, delay: calc(3.1) },
        }}
        onAnimationComplete={onAnimationComplete}
      />
    </motion.svg>
...
export { AppleHelloEnglishEffect, AppleHelloVietnameseEffect, AppleHolaEffect };
